...
package com.arash.altafi.extensionfunction.test5.extensions.time

import android.os.Build
import androidx.annotation.RequiresApi
import com.arash.altafi.extensionfunction.test5.extensions.number.roundDiv
...
object Durations {
    ...
    fun fromMillis(ago: Long) = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        Duration.ofMillis(millis() - ago)
    } else {
