...
package com.arash.altafi.extensionfunction.test5.extensions.arrays

import com.arash.altafi.extensionfunction.test5.extensions.collections.timesToListOf
import me.carleslc.kotlin.extensions.arrays.array2d
import java.util.*
...
//
//inline fun <T> array2dOf(vararg ts: Array<T>) = Array(ts.size) { ts[it] }
//
//inline fun <T> array2d(rows: Int, initCol: (Int) -> Array<T>) = Array(rows, { row -> initCol(row) })
