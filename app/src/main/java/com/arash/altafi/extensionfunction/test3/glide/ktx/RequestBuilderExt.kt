...
package com.arash.altafi.extensionfunction.test3.glide.ktx
...
import com.chayangkoon.champ.glide.ktx.ImageResult
...
//            offer(ImageResult.LoadStarted(placeholder))
            trySend(ImageResult.LoadStarted(placeholder)).isSuccess
        }

        override fun onResourceReady(resource: T, transition: Transition<in T>?) {
//            offer(ImageResult.SourceReady(resource, transition))
            trySend(ImageResult.SourceReady(resource, transition)).isSuccess
        }

        override fun onLoadFailed(errorDrawable: Drawable?) {
//            offer(ImageResult.LoadFailed(errorDrawable))
            trySend(ImageResult.LoadFailed(errorDrawable)).isSuccess
        }

        override fun onLoadCleared(placeholder: Drawable?) {
//            offer(ImageResult.LoadCleared(placeholder))
            trySend(ImageResult.LoadCleared(placeholder)).isSuccess
        }
    })
