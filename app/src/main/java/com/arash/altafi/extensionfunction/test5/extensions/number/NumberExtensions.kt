...
package com.arash.altafi.extensionfunction.test5.extensions.number

import android.os.Build
import com.google.common.math.DoubleMath
import com.google.common.math.LongMath
import com.arash.altafi.extensionfunction.test5.extensions.strings.toFixed
...
inline fun Double.nextDown(): Double = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
    this.nextDown()
} else {
    TODO("VERSION.SDK_INT < N")
}

inline fun Float.nextDown(): Float = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
    this.nextDown()
} else {
    TODO("VERSION.SDK_INT < N")
}
